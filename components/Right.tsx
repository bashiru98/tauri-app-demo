...
const Right = ({func, feels, hum, max, min, country, description, speed, input, submit, text}:Props) => {
  return (
    <div className="w-1/3 h-full bg-dark-rgba">
        ...
        <div className="relative z-0 w-full group">
			<input type="text" className="block py-2.5 px-0 w-full text-sm text-gray-400 bg-transparent 
			...
			<label  className="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 
